    ...
    if (!isNaN(currentAge) && !isNaN(targetYear)) {
        if (targetYear < birthYear) {
            ...
            document.getElementById('programGroup').style.display = 'block';
                ...
                if (programType === 'bachelor') {
                    ...
                    // }
                         ...
                         document.getElementById('result').innerText = `In the year ${targetYear}, you would be in grade ${grade}`;
                    }
            ...
            if (gradeInTargetYear < 1) {
                document.getElementById('result').innerText = `In the year ${targetYear}, you were not yet in school`;
            } else {
                document.getElementById('result').innerText = `In the year ${targetYear}, you were in grade ${gradeInTargetYear}`;
            }
        }
    } else {
